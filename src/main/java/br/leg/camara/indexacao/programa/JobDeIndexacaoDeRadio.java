...
public class JobDeIndexacaoDeRadio extends JobSqlParametrizavelPrograma {

	static final String NOME_PREFIXO_PROPRIEDADE = "camaranews";
	static final String NOME_DO_INDICE = "programas-radio";
	...
	protected String sqlTodosDocumentos() {
		 return criarSql("n.ID as id, n.post_title as titulo, n.post_excerpt as resumo, "
					...
					"n.post_date as data, YEAR(n.post_date) as ano, 'radio-camara' as veiculo, n.post_date as dataOrdenacao, "
	...
	private String criarSql(String colunasSelect, String orderBy) {
		return "select " + colunasSelect +
				...
				" where n.post_type = 'edicao_programa_radi' " + 
