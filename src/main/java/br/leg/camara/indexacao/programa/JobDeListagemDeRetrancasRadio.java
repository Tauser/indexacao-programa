...
/**
 * Lista as retrancas de radio, que serão agregadas em {@link JobDeIndexacaoDeRetrancasDasRadio}
 */
public class JobDeListagemDeRetrancasRadio extends JobSqlParametrizavelPrograma {
	...
	private String criarSql(String colunasSelect, String orderBy) {
		return "select " + colunasSelect +
				...
				" and (SELECT ps.ID FROM wp_posts ps where ps.ID = tr.object_id and ps.post_type ='edicao_programa_radi' and ps.post_status = 'publish') "+
