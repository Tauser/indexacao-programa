 ...
 */
public class JobDeIndexacaoDeAudioDeRadio extends JobAgregadorDeDocumentos<JobDeListagemDeAudioRadio> {

	private JdbcTemplate jdbcTemplate;
	private Util util = new Util();
	List<DTOMidia> audiosWP;
	...
	private DataSource criarDatasource(Configuracoes configuracoes) {
		String prefixoPropriedades = "jobs." + JobDeIndexacaoDeRadio.NOME_PREFIXO_PROPRIEDADE + ".datasource.";
	...
	public void iniciar(ParametrosExecucao parametros) {
		...
		audiosWP = jdbcTemplate.query(sqlTodosAudios(), new RowMapper<DTOMidia>() {
	...
	@Override
	protected JobDeListagemDeAudioRadio criarJobAlvo() {
		return new JobDeListagemDeAudioRadio();
	}

	@Override
	protected String nomeDoCampoAgregado() {
		return JobDeListagemDeAudioRadio.NOME_CAMPO;
	}
